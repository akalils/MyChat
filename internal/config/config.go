...
func LoadConfig() error {
	// // 本地部署
	// if _, err := toml.DecodeFile("/Users/lisheng/LishengChat-main/configs/config.toml", config); err != nil {
	// 	log.Fatal(err.Error())
	// 	return err
	// }
	// return nil
	// Ubuntu22.04云服务器部署
	if _, err := toml.DecodeFile("/home/project/LishengChat-main/configs/config.toml", config); err != nil {
		log.Fatal(err.Error())
		return err
	}
	return nil
